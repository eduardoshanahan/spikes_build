...
env.application_code_directory = 'case02'
...
def list_processes():
    ...
    """
    run("ps axo ppid,pid,command | grep forever")
...
@task
def build(code_directory=env.application_code_directory):
    """
